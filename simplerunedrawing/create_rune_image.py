...
expected_rune_filenames: List[str] = [
    ...
    "reversed_Nied.png",
    "reversed_Othel.png",
    "reversed_Perdhro.png",
    "reversed_Raido.png",
    "reversed_Sigel.png",
    "reversed_Thurisaz.png",
    "reversed_Tir.png",
    "reversed_Uruz.png",
    "reversed_Wunjo.png",
]
...
rune_image_folder: str = (
    r"Runes"  # Default path to rune images - this can be overridden by the CLI option in main.py
)
...
def create_rune_layout(_rune_image_folder: str, runes: list[str]) -> Image.Image:
    ...
    if missing_images:
        raise ValueError(
            f"One or more runes do not have corresponding images: {missing_images}"
        )
    ...
    match number_of_runes:
        ...
        case _:
            raise ValueError(
                f"Invalid number of runes {number_of_runes} for the layout generation."
            )
